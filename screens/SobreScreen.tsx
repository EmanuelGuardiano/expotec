...
const players: Player[] = [
  ...
  { name: 'Prof. Renan', img: require('../assets/prof.renan.jpeg'), role: 'professor' },
  ...
  { name: 'Miguel', img: require('../assets/miguel.jpeg'), role: 'aluno' },
  { name: 'Julio Cesar', img: require('../assets/julio.jpeg'), role: 'aluno' },
  { name: 'Lucas', img: require('../assets/lucas.jpeg'), role: 'aluno' },
